...
public class States {
	...
	private static List<String> getListOfStatesAndTerritories() {
		return new ArrayList<String>(Arrays.asList("AK", "AL", "AR", "AS", "AZ", "CA", "CO", "CT", "DE", "FL", "GA",
				"GU", "HI", "IA", "ID", "IL", "IN", "KS", "KY", "LA", "MA", "MD", "ME", "MI", "MN", "MO", "MS", "MT",
				"NC", "ND", "NE", "NH", "NJ", "NM", "NV", "NY", "OH", "OK", "OR", "PA", "PR", "RI", "SC", "SD", "TN",
